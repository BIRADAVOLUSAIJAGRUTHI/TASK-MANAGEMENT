    ...
    return (`<div class="col-md-6 col-lg-4 mt-3" id=${id} key=${id}>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <spam class="badge bg-primary">${type}</spam>
            </div>
...
const saveToLocalStorage = () => {
    localStorage.setItem("jagruthitasks", JSON.stringify({jagruthi: globalTaskData}));
}

const reloadTaskCard = () => {
    const localStorageCopy = JSON.parse(localStorage.getItem("jagruthitasks"));
    console.log(localStorageCopy);
    if (localStorageCopy) {
        globalTaskData = localStorageCopy["jagruthi"];
    }
